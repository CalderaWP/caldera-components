...
describe('Adding automatic validation', function () {
	...
	it('Does not change validators if already set', function () {
		...
		expect((0, _addAutomaticValidators.addAutomaticValidators)(configField).validators).toEqual(validators);
	});
	...
	describe('Adding email validators', function () {
		...
		it('adds validator for email fields', function () {
			expect((0, _addAutomaticValidators.addAutomaticValidators)(_extends({}, emailFieldConfig, {
				ID: 'fld01'
		...
		it('Valid emails validate true', function () {
			...
			var values = (0, _util.reduceConfigFieldsToValues)([configField]);
			expect((0, _addAutomaticValidators.addAutomaticValidators)(configField).validators[0](values)).toEqual(true);
		});
		...
		it('Invalid emails validate false', function () {
			...
			var values = (0, _util.reduceConfigFieldsToValues)([configField]);
			expect((0, _addAutomaticValidators.addAutomaticValidators)(configField).validators[0](values)).toEqual(false);
		});
	...
	describe('Adding url validators', function () {
		...
		it('adds validator for text fields', function () {
			expect((0, _addAutomaticValidators.addAutomaticValidators)(_extends({}, urlFieldConfig, {
				ID: 'fld01'
			})).validators).toHaveLength(1);
		});
	...
	describe('select field validator', function () {
		...
		it('adds a validator for select fields', function () {
			...
			expect((0, _addAutomaticValidators.addAutomaticValidators)(configField).validators).toHaveLength(1);
		});
